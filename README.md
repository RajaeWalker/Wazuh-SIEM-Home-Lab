...
The following screenshots document each stage of the Wazuh SIEM deployment, from infrastructure verification through endpoint onboarding, telemetry collection, and alert generation.

---

# Phase 1 – Infrastructure Verification

Before onboarding endpoints, all core Wazuh services were verified to ensure the SIEM infrastructure was operational.

### Wazuh Manager

**Purpose:**  
Verified the Wazuh Manager service was active and running on the Ubuntu Server.
...
**Purpose:**  
Verified the Wazuh Indexer service was active and capable of storing and indexing security events.
...
**Purpose:**  
Verified the Wazuh Dashboard service was active and accessible over HTTPS.
...
**Purpose:**  
Verified both the Wazuh Agent (WazuhSvc) and Microsoft Sysmon (Sysmon64) services were running on the Windows 11 endpoint.
...
Once the infrastructure was confirmed operational, the Windows endpoint was successfully enrolled into the Wazuh environment.

### Active Endpoint Enrollment

**Purpose:**  
Verified WIN11-ENDPOINT successfully registered with the Wazuh Manager and was reporting as an active monitored agent.
...
**Purpose:**  
Verified Wazuh successfully collected endpoint inventory information including operating system, IP address, hardware specifications, and agent metadata.
...
After endpoint onboarding, Sysmon telemetry was collected, processed by Wazuh, and used to generate security alerts.

### Sysmon Process Creation (Event ID 1)

**Purpose:**  
Verified Process Creation events generated by Sysmon were successfully collected and displayed in the Wazuh Dashboard.

*Insert Event ID 1 screenshot*

---

### Wazuh Detection Alert (Level 15)

**Purpose:**  
Verified a built-in Wazuh detection rule generated a Level 15 alert after analyzing Sysmon telemetry.
...
**Purpose:**  
Verified alert enrichment including Rule ID 92213, severity level, and associated MITRE ATT&CK mapping.
...
**Purpose:**  
Verified Sysmon File Creation events were successfully ingested and analyzed by the Wazuh platform.
